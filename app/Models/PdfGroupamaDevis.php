...
class PdfGroupamaDevis extends Fpdf
{
    public function header(){
        ...
        $this->Cell(80);
        // Titre
        $this->Cell(30,10,utf8_decode('Devis assurance bâtiment'),0,0,'C');
        // Saut de ligne
        $this->Ln();
    }
