                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <?php if($value_in_nbr_sinistre >= 10): ?>
                                        ...
                                        <?php else: ?>
                                        <div class="col-md-4">
                                            <label>Surface</label><input type="text" name="in_nombre_surface" value="<?php echo e($value_in_nbr_surface); ?>">
                                            <br>
                                            <label>Sinistre(s)</label><input type="text" name="in_nombre_sinistres" disabled="disabled" value="<?php echo e($value_in_nbr_sinistre); ?>"><br>
