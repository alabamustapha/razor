...
<?php if(sizeof($warnings) == 0): ?>
    ...
    <br><div class="form_field"><a href="<?php echo e(url('home')); ?>">Annuler</a> - <a class="btn-orange-a" href="<?php echo e(url('tarificateurbatiment/tarifbat_step2')); ?>">Aller &agrave; l'&eacute;tape 2</a></div>
<?php else: ?>
