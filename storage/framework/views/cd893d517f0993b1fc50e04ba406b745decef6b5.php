                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <?php if($coef_zone < 9){ echo '0';} echo $coef_zone + 1; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" width="50%">
                                            <table class="tarificateur" cellspacing="0" cellpadding="1">
                                                ...
                                                <tr>
                                                    <td>Occupant</td>
                                                    <td>Oui <input type="radio" value="1" name="in_risk_occupant" checked> 
                                                        Non <input type="radio" value="0" name="in_risk_occupant" >
                                                    </td>
                                                </tr>
