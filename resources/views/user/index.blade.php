            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a class="btn-orange-a" href="{{ route('user.create')}}"><i class="fa fa-plus-circle" aria-hidden="true"></i>Ajouter un affilié</a>
                        <table class="table">
                            <thead>
                            <tr>
                                <th>Status</th>
                            ...
                            @foreach($user as $user_affil)
                                <tr>
                                    ...
                                    <td><a href="{{ route('user.edit', $user_affil->id)}}"><i class="fa fa-pencil-square-o"></i></a>
                                        ...
                                        <a class="btn-orange-a" href="{{route('courtier_affilie', $user_affil->id)}}">Gérer les courtiers</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
