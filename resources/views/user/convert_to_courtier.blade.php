        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading"><center><h5>Sélectionner l'affilié auquel rattaché le courtier {{$user->aff_lname}}, {{$user->aff_fname}} et les données liées :</h5></center></div>
                    <div class="panel-body">
                        <center><form method="post" action="{{ route('update_afflink_post', $user->id) }}">
