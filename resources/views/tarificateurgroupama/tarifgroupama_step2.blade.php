            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ url('tarificateurgroupama/tarifgroupama_step3') }}" method="post" name="form_proposant_s2"><center><table><tr><td valign="top" width="50%">
                                        ...
                                        </td></tr></table><div class="form_field"><a href="{{ url('home') }}">Annuler</a> - <button class="btn-orange-a" style="border: none!important; background-color: transparent" type="submit">Aller à l'étape 3</button></div></center>
                        </form>
                    </div>
                </div>
            </div>
