            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('tarificateurbatiment') }}" style="background-color:#d08639!important; border-color: #d08639!important;" class="btn btn-primary">Tarificateur Bâtiment inférieur à 1500m2</a>
                        <a href="{{ url('tarificateurgroupama/nbr_sinistre') }}" style="background-color:#d08639!important; border-color: #d08639!important;" class="btn btn-primary">Tarificateur Bâtiment supérieur à 1500m2</a>
                        </div>
                </div>
                <div class="container">
                    <div class="row">
